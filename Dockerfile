...
ARG NGINX_COMMON_CC_OPT="-g -O2 -fno-omit-frame-pointer -fstack-protector-strong -fstack-clash-protection -Wformat -Werror=format-security -fPIC -Wdate-time -D_FORTIFY_SOURCE=3"
...
ENV ADD_PACKAGES="curl ca-certificates atool autoconf jq yq checkinstall apt-utils gnupg gpg-agent libssl-dev zlib1g-dev libpcre2-dev libpcre3-dev"
